...
@Table(name = "refunds", uniqueConstraints = {
        @UniqueConstraint(name = "uk_refunds_refund_no", columnNames = "refund_no"),
        @UniqueConstraint(name = "uk_refunds_idempotency_key", columnNames = "idempotency_key"),
        @UniqueConstraint(name = "uk_refunds_merchant_refund_no", columnNames = "merchant_refund_no")
})
public class Refund {
    ...
    public Refund(String refundNo, String idempotencyKey, String requestFingerprint,
