...
import com.chris64233.ccpayment.payment.dispute.PaymentDisputeResolutionType;
import jakarta.validation.constraints.NotBlank;
import jakarta.validation.constraints.NotNull;
import jakarta.validation.constraints.Size;

public record PaymentDisputeResolutionRequest(

        @NotNull(message = "处理结论不能为空")
        PaymentDisputeResolutionType resolution,
